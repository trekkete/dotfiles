# Generated by Powerlevel10k configuration wizard on 2021-11-06 at 18:35 CET.
...
# blurred heads, sharp tails, 2 lines, solid, left frame, sparse, concise,
...
() {
  ...
  # Filler between left and right pro2mpt on the first prompt line. You can set it to ' ', '·' or
